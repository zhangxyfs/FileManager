package com.z7dream.manager.widget;
...
/**
 * Created by duCong on 16/4/6.
 */
public class TCheckBox extends View implements Checkable {
    ...
    public TCheckBox(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        checkDrawable = context.getResources().getDrawable(R.drawable.ic_checkbox);
        ...
        setOnClickListener(v -> {
            ...
            mOnCheckListener.checkListener(this, isChecked);
        });
    }
    ...
    public interface OnCheckListener {
        void checkListener(TCheckBox tcb, boolean isCheck);
    }
}
