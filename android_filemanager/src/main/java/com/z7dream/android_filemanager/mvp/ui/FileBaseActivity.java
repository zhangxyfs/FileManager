...
import com.z7dream.android_filemanager.mvp.contract.FileBaseContract;
import com.z7dream.android_filemanager.mvp.presenter.FileBasePresenter;
import com.z7dream.android_filemanager.mvp.ui.adapter.FileBaseListAdapter;
...
import static com.z7dream.android_filemanager_lib.tool.Utils.expandOCollapseAnim;
...
public class FileBaseActivity extends BaseActivity<FileBaseContract.Presenter> implements FileBaseContract.View, SwipeRefreshLayout.OnRefreshListener,
    ...
    public void onChildTypeClickListener(int viewId) {
        ...
        if (fileType >= 0)
            FileManagerActivity.open(this, titleName, fileType, picMaxSize, fileMax, picMaxSize + fileMax, FileManagerActivity.FUN_NORMAL
                    , isToForward, isNeedZip, true, FileType.createIconResId(fileType), requestCode);
